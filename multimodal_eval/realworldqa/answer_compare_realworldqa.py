...
if __name__ == "__main__":
   ...
   data_json_path = "/datasets/language_eval/realworldqa/realworldqa.json"
   results_json_path = "multimodal_eval/realworldqa/results/mantis_results_20251106_052040.json"
