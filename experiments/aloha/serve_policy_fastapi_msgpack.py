...
def main(args: Args) -> None:
    ...
    policy = MantisVLA(
        model_id = "/data/yangyi/mantis_action_refactoring/output_aloha_numbers/mantis_image_action_language_aloha_numbers/checkpoint-11000",
        checkpoints_dir = "/data/yangyi/mantis_action_refactoring/checkpoints_aloha_numbers/whole_model/epoch10_05_step6000"
    )
...
#  uv run /data/yangyi/mantis_action_refactoring/experiments/aloha/serve_policy_fastapi_msgpack.py --port 8000