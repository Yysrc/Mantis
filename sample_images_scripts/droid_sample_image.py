...
result_dir = "/data/yangyi/mantis_action_refactoring/samples/libero_goal"
...
###### load image heads ######
# mantis.model.transformer.load_state_dict(
#     torch.load(os.path.join(checkpoints_dir, "image_head.pt"), map_location=device)
# )
# mantis.model.connector.load_state_dict(
...
# mantis.model.mllm_backbone.model.embed_tokens.weight = torch.nn.Parameter(embed_weight)
